...
for ($i=0;$i<count($get_item_list);$i++){
    ...
    $item_url = $encode->encode("cmd=game_event_itemchange&item_type=$item_type&step_belong_id=$step_belong_id&step_id=$step_id&item_name=$item_name&item_id=$item_id&sid=$sid");//
    $item_list .=<<<HTML
