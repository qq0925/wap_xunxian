...
$totalPages = ceil($totalRows / $list_row);
    ...
    if ($ltcxjg){
        ...
        【公共|<a href='?cmd=$imliaotian'>私聊</a>|<a href='?cmd=$cityliaotian'>城聊</a>|<a href='?cmd=$arealiaotian'>区聊</a>|<a href='?cmd=$teamliaotian'>队聊</a>|<a href='?cmd=$systemliaotian'>系聊</a>】<br/>
...
$totalPages = ceil($totalRows / $list_row);
    ...
    if ($ltcxjg){
        ...
        $lthtml = "【聊天频道：私聊】<a href='?cmd=$imliaotian'>刷新</a> <br/>【<a href='?cmd=$goliaotian'>公共</a>|私聊|<a href='?cmd=$cityliaotian'>城聊</a>|<a href='?cmd=$arealiaotian'>区聊</a>|<a href='?cmd=$teamliaotian'>队聊</a>|<a href='?cmd=$systemliaotian'>系聊</a>】<br/>";
        for ($i=0;$i < count($ret);$i++){
            $uname = $ret[$i]['name'];
            $umsg = $ret[$i]['msg'];
            $umsg = \lexical_analysis\color_string($umsg);
...
$totalPages = ceil($totalRows / $list_row);
    ...
    if ($ltcxjg){
        ...
        【<a href='?cmd=$goliaotian'>公共</a>|<a href='?cmd=$imliaotian'>私聊</a>|城聊|<a href='?cmd=$arealiaotian'>区聊</a>|<a href='?cmd=$teamliaotian'>队聊</a>|<a href='?cmd=$systemliaotian'>系聊</a>】<br/>
        <span style='font-weight : bold ; color: red'>请勿发表有关辱骂、政治、色情、赌博等相关言论！请确保您的言论符合游戏规则和道德准则。违反规则将导致相应的惩罚措施，包括禁言、封号等。</span><br/>";
        for ($i=0;$i < count($ret);$i++){
            $uname = $ret[$i]['name'];
            $umsg = $ret[$i]['msg'];
...
$totalPages = ceil($totalRows / $list_row);
    ...
    if ($ltcxjg){
        ...
        【<a href='?cmd=$goliaotian'>公共</a>|<a href='?cmd=$imliaotian'>私聊</a>|<a href='?cmd=$cityliaotian'>城聊</a>|区聊|<a href='?cmd=$teamliaotian'>队聊</a>|<a href='?cmd=$systemliaotian'>系聊</a>】<br/>
        <span style='font-weight : bold ; color: red'>请勿发表有关辱骂、政治、色情、赌博等相关言论！请确保您的言论符合游戏规则和道德准则。违反规则将导致相应的惩罚措施，包括禁言、封号等。</span><br/>";
        for ($i=0;$i < count($ret);$i++){
            $uname = $ret[$i]['name'];
            $umsg = $ret[$i]['msg'];
...
$totalPages = ceil($totalRows / $list_row);
    ...
    if ($ltcxjg){
        ...
        【<a href='?cmd=$goliaotian'>公共</a>|<a href='?cmd=$imliaotian'>私聊</a>|<a href='?cmd=$cityliaotian'>城聊</a>|<a href='?cmd=$arealiaotian'>区聊</a>|队聊|<a href='?cmd=$systemliaotian'>系聊</a>】<br/>
        <span style='font-weight : bold ; color: red'>请勿发表有关辱骂、政治、色情、赌博等相关言论！请确保您的言论符合游戏规则和道德准则。违反规则将导致相应的惩罚措施，包括禁言、封号等。</span><br/>";
        for ($i=0;$i < count($ret);$i++){
            $uname = $ret[$i]['name'];
            $umsg = $ret[$i]['msg'];
