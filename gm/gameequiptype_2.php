...
$equip_main = "?cmd=gm_equip_def&def_post_canshu=3&gm_post_canshu=1&sid=$sid";
$equip_html = <<<HTML
<p>[装备类型定义]<br/>
增加兵器类别<br/>
</p>
<form action=$equip_main method="post">
...
$gm = $encode->encode("cmd=gm&sid=$sid");
$equip_main = "?cmd=gm_equip_def&def_post_canshu=3&gm_post_canshu=2&sid=$sid";
$equip_html = <<<HTML
<p>[装备类型定义]<br/>
增加防具类别<br/>
</p>
