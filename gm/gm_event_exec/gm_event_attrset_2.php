...
$gm_game_globaleventdefine_attr_last = $encode->encode("cmd=game_event_attrset&step_belong_id=$step_belong_id&step_id=$step_id&sid=$sid");
...
// 生成并保存Excel文件
$excelFileName = 'in_data/attr_setting.xlsx';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['excel_file'])) {
    ...
    // 首先获取当前的s_attrs值
    $query = "SELECT s_attrs FROM system_event_evs WHERE belong = :evs_belong AND id = :evs_id";
    ...
    // 更新数据库
    $update_sql = "UPDATE system_event_evs SET s_attrs = :s_attrs WHERE belong = :evs_belong AND id = :evs_id";
