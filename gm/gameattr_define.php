...
$gm_game_attrdefine_2 = $encode->encode("cmd=gm_game_attrdefine&gm_post_canshu=2&sid=$sid");
...
$sql = "select * from gm_game_attr where value_type = '$gm_post_canshu'";
//var_dump($sql);
...
for ($i=0;$i<count($gm_ret);$i++){
   ...
   // var_dump($gm_djname);
    ...
    $attr_html .=<<<HTML
    <a href="?cmd=$gm_game_attrdefine_8">{$gm_djname}[{$gm_djid}]</a><br/>
HTML;
}
}
...
<a href="?cmd=$gm_game_attrdefine_2">定义查看玩家显示属性</a><br/>
...
<a href="?cmd=$gm_game_attrdefine_6">定义技能属性</a><br/><br/>
...
break;
case '2':
$gm_game_attrdefine = $encode->encode("cmd=gm_game_attrdefine&gm_post_canshu=8&gm_post_type_2=2&gm_post_canshu_2=$gm_post_canshu&sid=$sid");
$gm_game_attrdefine_2 = $encode->encode("cmd=gm_game_attrdefine&gm_post_canshu=0&sid=$sid");
$gm_html = <<<HTML
[当前定义的查看玩家显示属性]<br/>
$attr_html<br/>
...
$gm_delete_attr = $encode->encode("cmd=gm_delete_attr&gm_game_attr_id=$gm_game_attr_id&gm_post_canshu=$gm_post_type_2&sid=$sid");
$gm_html = <<<HTML
修改属性
$post_tishi<br/>
<form>
<input type="hidden" name="cmd" value="gm_post_2">
<input name="gm_post_canshu" type="hidden" value="$gm_post_canshu">
<input name="gm_post_canshu_2" type="hidden" value="$gm_post_canshu_2">
<input name="gm_post_canshu_3" type="hidden" value="1">
<input name="gm_post_type_2" type="hidden" value="$gm_post_type_2">
...
<form>
<input type="hidden" name="cmd" value="gm_post_2">
<input name="gm_post_canshu_2" type="hidden" value="$gm_post_type_2">
<input name="gm_post_canshu" type="hidden" value="8">
<input name="gm_post_type_2" type="hidden" value="$gm_post_type_2">
<input type="hidden" name="sid" value="$sid">
