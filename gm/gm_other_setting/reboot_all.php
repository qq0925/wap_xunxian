...
$data = [
    ...
    [35, 'hp', '生命', 3, 100, 0, 0, 0, 0],
    [36, 'maxhp', '最大生命', 3, 100, 0, 1, 1, 0],
    [37, 'mp', '法力', 3, 100, 0, 1, 0, 0],
    [38, 'maxmp', '最大法力', 3, 0, 0, 1, 1, 0],
    [39, 'speed', '出招速度', 3, 1, 0, 1, 1, 0],
    [40, 'gj', '攻击力', 3, '', 0, 1, 0, 0],
    [41, 'fy', '防御力', 3, '', 0, 1, 0, 0],
    [42, 'kill', '是否可pk', 1, '', 0, 1, 0, 2],
    [43, 'id', '标识', 4, 1, 0, 1, 0, 0],
