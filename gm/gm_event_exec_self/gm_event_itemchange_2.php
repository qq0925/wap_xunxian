...
$item_post = $encode->encode("cmd=game_event_itemchange_self&canshu=change&event_id=$event_id&step_id=$step_id&sid=$sid");
}else{
$gm_game_selfeventdefine_item_last = $encode->encode("cmd=game_event_itemchange_self&add_action=1&gm_post_canshu_2=$item_type&event_id=$event_id&step_id=$step_id&sid=$sid");
$item_post = $encode->encode("cmd=game_event_itemchange_self&canshu=add&event_id=$event_id&step_id=$step_id&sid=$sid");
$item_count = 1;
}
