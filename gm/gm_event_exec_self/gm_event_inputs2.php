<?php
$gm_game_selfeventdefine_input_last = $encode->encode("cmd=game_event_inputs_self&event_id=$event_id&step_id=$step_id&sid=$sid");
$input_post = $encode->encode("cmd=game_event_inputs_self&event_id=$event_id&step_id=$step_id&sid=$sid");
...
<a href="?cmd=$gm_game_selfeventdefine_input_last">返回字段列表</a><br/>
HTML;
echo $input_html;
?>